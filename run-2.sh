...
if [ $stage -le 25 ]; then
  sbatch local/chain/run_training.sh --hparams hyperparams/chain/FIX-CRDNN-AA.yaml
  exit
fi
...
if [ $stage -le 27 ]; then
  local/chain/decode.sh --datadir data/lp-dev/ \
    ...
    --hparams hyperparams/chain/FIX-CRDNN-AA.yaml \
    --decodedir "exp/chain/FIX-CRDNN-AA/2602-2856units/decode_lp-dev_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/parl-dev-all/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --hparams hyperparams/chain/FIX-CRDNN-AA.yaml \
    --decodedir "exp/chain/FIX-CRDNN-AA/2602-2856units/decode_parl-dev-all_bpe.5000.varikn_acwt1.5"
fi

if [ $stage -le 28 ]; then
  sbatch local/chain/run_training.sh --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml
  exit
fi
...
if [ $stage -le 31 ]; then
  local/chain/decode.sh --datadir data/dev_all/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_dev_all_bpe.5000.varikn_acwt1.5"
fi
...
if [ $stage -le 33 ]; then
  ...
  local/chain/decode.sh --datadir data/lp-dev/ \
    ...
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_lp-dev_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/parl-dev-all/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-dev-all_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/parl-test-2020/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_bpe.5000.varikn \
   --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-test-2020_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/parl-test-all/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_bpe.5000.varikn/ \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-test-all_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/lp-test/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_lp-test_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/yle-test-new \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_yle-test-new_bpe.5000.varikn_acwt1.5"
  exit
fi
...
if [ $stage -le 34 ]; then
  ...
  local/chain/decode.sh --datadir data/parl-dev-all/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --stage 2 --posteriors_from exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-dev-all_bpe.5000.varikn_acwt1.5/ \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_parl_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-dev-all_parl_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/lp-dev/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --stage 2 --posteriors_from exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_lp-dev_bpe.5000.varikn_acwt1.5/ \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_parl_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_lp-dev_parl_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/parl-test-2020/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --stage 2 --posteriors_from exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-test-2020_bpe.5000.varikn_acwt1.5/ \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_parl_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-test-2020_parl_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/parl-test-all/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --stage 2 --posteriors_from exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-test-all_bpe.5000.varikn_acwt1.5/ \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_parl_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-test-all_parl_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/lp-test/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --stage 2 --posteriors_from exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_lp-test_bpe.5000.varikn_acwt1.5/ \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_parl_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_lp-test_parl_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/yle-test-new \
    --stage 2 --posteriors_from "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_yle-test-new_bpe.5000.varikn_acwt1.5" \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_parl_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd/2602-2856units/decode_yle-test-new_parl_bpe.5000.varikn_acwt1.5"
  exit
fi
...
if [ $stage -le 35 ]; then
  ...
  local/chain/decode.sh --datadir data/parl-dev-all/ \
    ...
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-dev-all_lp_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/lp-dev/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --stage 2 --posteriors_from exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_lp-dev_bpe.5000.varikn_acwt1.5/ \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_lp_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_lp-dev_lp_bpe.5000.varikn_acwt1.5"
  ...
  local/chain/decode.sh --datadir data/parl-test-2020/ \
    ...
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_lp_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-test-2020_lp_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/parl-test-all/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --stage 2 --posteriors_from exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-test-all_bpe.5000.varikn_acwt1.5/ \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_lp_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_parl-test-all_lp_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/lp-test/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --stage 2 --posteriors_from exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_lp-test_bpe.5000.varikn_acwt1.5/ \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_lp_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_lp-test_lp_bpe.5000.varikn_acwt1.5"
  local/chain/decode.sh --datadir data/yle-test-new \
    --stage 2 --posteriors_from "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_yle-test-new_bpe.5000.varikn_acwt1.5" \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_lp_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd/2602-2856units/decode_yle-test-new_lp_bpe.5000.varikn_acwt1.5"
  exit
fi
...
if [ $stage -le 36 ]; then
  ...
  local/chain/decode.sh --datadir data/dev-all/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_dev-all_bpe.5000.varikn_acwt1.5"

  local/chain/decode.sh --datadir data/dev-all/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_lp_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_dev-all_lp_bpe.5000.varikn_acwt1.5"

  local/chain/decode.sh --datadir data/dev-all/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_parl_bpe.5000.varikn/ \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_dev-all_parl_bpe.5000.varikn_acwt1.5"


local/chain/decode.sh --datadir data/lp-dev/ \
    --acwt 1.5 --post-decode-acwt 15.0 \
    --stage 3 --score_opts '--min_lmwt 17 --max_lmwt 20' \
    --hparams hyperparams/chain/FIX-CRDNN-AA-contd.yaml \
    --graphdir exp/chain/graph/graph_bpe.5000.varikn \
    --decodedir "exp/chain/FIX-CRDNN-AA-contd//2602-2856units/decode_lp-dev_bpe.5000.varikn_acwt1.5"
